...
# 设置随机数种子
random_state = 31 # 42 for jingxi3 36 for 3 31 for 128
...
class EEGNet(nn.Module): # from https://github.com/torcheeg/torcheeg/blob/main/torcheeg/models/cnn/eegnet.py
    r'''
